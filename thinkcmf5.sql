...
MySQL - 5.5.53 : Database - thinkcmf5
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`thinkcmf5` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
insert  into `cmf_theme`(`id`,`create_time`,`update_time`,`status`,`is_compiled`,`theme`,`name`,`version`,`demo_url`,`thumbnail`,`author`,`author_url`,`lang`,`keywords`,`description`) values (1,0,0,0,0,'simpleboot3','simpleboot3','1.0.2','http://demo.thinkcmf.com','','ThinkCMF','http://www.thinkcmf.com','zh-cn','ThinkCMF模板','ThinkCMF默认模板');
...
insert  into `cmf_user`(`id`,`user_type`,`sex`,`birthday`,`last_login_time`,`score`,`coin`,`balance`,`create_time`,`user_status`,`user_login`,`user_pass`,`user_nickname`,`user_email`,`user_url`,`avatar`,`signature`,`last_login_ip`,`user_activation_key`,`mobile`,`more`) values (1,1,0,0,1558408036,1,1,'0.00',1556087659,1,'admin','###706de1c0195f75d2d5c7b479624ffc46','admin','2323178881@qq.com','','','','127.0.0.1','','',NULL),(2,2,0,0,0,0,0,'0.00',1556091540,1,'','###8d6ad3a7bb4776e20f736321f4576367','','','','','','','','18329123270',NULL);
...
insert  into `cmf_user_score_log`(`id`,`user_id`,`create_time`,`action`,`score`,`coin`) values (1,1,1556087696,'login',1,1);
...
insert  into `cmf_user_token`(`id`,`user_id`,`expire_time`,`create_time`,`token`,`device_type`) values (1,1,1571645396,1556093396,'117dda9ec75fcd3d85aec6702967819f117dda9ec75fcd3d85aec6702967819f','web');
...
insert  into `cmf_verification_code`(`id`,`count`,`send_time`,`expire_time`,`code`,`account`) values (1,1,1556091492,1556093292,'998159','18329123270');
